...
if __name__ == "__main__":
	try:
		...
		lb_motor = TransMotor('lb', 4, 1) # init translational motors TransMotor(name, address, sign). sign is for each motor either +1 or -1
		while not rospy.is_shutdown():
			...
			lb_motor.pub_wheel_vel() # publish wheel velocity
